    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.projects.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('top') ? 'is-invalid' : '' }}" type="text" name="top" id="top" value="{{ old('top', '') }}">
                @if($errors->has('top'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('left') ? 'is-invalid' : '' }}" type="text" name="left" id="left" value="{{ old('left', '') }}">
                @if($errors->has('left'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descreption') ? 'is-invalid' : '' }}" type="text" name="descreption" id="descreption" value="{{ old('descreption', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('transefer') ? 'is-invalid' : '' }}" name="transefer_id" id="transefer_id">
                    @foreach($transefers as $id => $entry)
                        <option value="{{ $id }}" {{ old('transefer_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('feeder') ? 'is-invalid' : '' }}" name="feeder_id" id="feeder_id">
                    @foreach($feeders as $id => $entry)
                        <option value="{{ $id }}" {{ old('feeder_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('second_feeder') ? 'is-invalid' : '' }}" type="text" name="second_feeder" id="second_feeder" value="{{ old('second_feeder', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('ct') ? 'is-invalid' : '' }}" name="ct_id" id="ct_id">
                    @foreach($cts as $id => $entry)
                        <option value="{{ $id }}" {{ old('ct_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('ct'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ct_postion') ? 'is-invalid' : '' }}" type="text" name="ct_postion" id="ct_postion" value="{{ old('ct_postion', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('rmu') ? 'is-invalid' : '' }}" name="rmu_id" id="rmu_id">
                    @foreach($rmus as $id => $entry)
                        <option value="{{ $id }}" {{ old('rmu_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('rmu'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('autorecloser') ? 'is-invalid' : '' }}" name="autorecloser_id" id="autorecloser_id">
                    @foreach($autoreclosers as $id => $entry)
                        <option value="{{ $id }}" {{ old('autorecloser_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sectionlazy') ? 'is-invalid' : '' }}" name="sectionlazy_id" id="sectionlazy_id">
                    @foreach($sectionlazies as $id => $entry)
                        <option value="{{ $id }}" {{ old('sectionlazy_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('avr') ? 'is-invalid' : '' }}" name="avr_id" id="avr_id">
                    @foreach($avrs as $id => $entry)
                        <option value="{{ $id }}" {{ old('avr_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('avr'))
